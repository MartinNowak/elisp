...
(defgroup save-abbreviation nil "Magically saving aliases to emacs lisps functions (abbreviations) to a file that is reloaded on startup. This is not to be confused with the abbrev package. There are other modes to provide automatic abbreviations for all emacs lisp functions.")
