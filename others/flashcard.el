...
(defvar flashcard-version "2.3.1"
...
(defcustom flashcard-insert-hook nil
  "This hook is run whenver `flashcard-insert' inserts data into the
flashcard buffer."
  :type 'hook
  :group 'flashcard)
...
(defcustom flashcard-positive-feedback-functions nil
  "This hook is run whenver the user answered a card, and should be
...
(defcustom flashcard-method-correct-p-function 'identity
  "This function is used when one needs to know wether the return
...
(defun flashcard-method-check-answer (card answer)
  "Ask the current method wether ANSWER is a correct answer to CARD.
...
(defun flashcard-method-correct-p (grade)
  "Ask the backend wether the return value of
...
(defun flashcard-import-from-colon-file (deck file) 
  "Import cards for DECK from FILE, which should be a colon-seperated
file. I.e.:
...
(defun flashcard-method-leitner-check-answer (card answer)
  "Insert the answer, ask the user wether he was correct, and return
the reply."
...
(defun flashcard-method-leitner-answered (card answer-correct-p)
  "Move CARD according to wether the user answered correctly. This is,
