;;; cantusethatname.el
;;; w32-shell-verb.el --- press the 'apps key (the 'menu' key between the right 'windows' and 'ctrl' keys on a windows keyboard) to ShellExecute the default 'verb' on that file (typically 'open')
