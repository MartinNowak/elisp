...
(defvar google-search-domains
  '("web" "local" "video" "blogs" "news" "books" "images")
...
\"blogs\", \"news\", \"books\", or \"images\"."
  (interactive (list (read-string "Terms: ")
                     nil
                     (completing-read "Search Domain: " google-search-domains nil t)))
     ...
     (url-retrieve-synchronously
      (format
       ...
       (mapconcat (lambda (cons)
                  ...
                  args
                  "&"))))))
(defalias 'google 'google-search)
;; Use: (call-interactively 'google)
