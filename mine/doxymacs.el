...
;; Change log:
;;
;; 10/10/2010 - version 1.8.1  Various fixes
      ...
      (when (boundp 'filladapt-token-table)
        (add-to-list 'filladapt-token-table
                     `(,(concat "[@\\]" "\\(" "t?param" "\\(?:" _*
                                ...
                                _+ W+ "\\|" "return" "\\)") 'bullet))
        (add-to-list 'filladapt-token-table
                     '("[\\@]\\(t?param\\|throw\\|exception\\|addtogroup\\|defgroup\\)[ \t]*[A-Za-z_][A-Za-z_0-9]*[ \t]+" bullet))
        (add-to-list 'filladapt-token-table
                     '("[\\@][A-Za-z_]+[ \t]*" bullet))
        ))))
...
(when nil                                  ;TODO: Change prefix!
  ...
  (define-key doxymacs-mode-map "\C-cDf" 'doxymacs-insert-function-comment)
  (define-key doxymacs-mode-map "\C-cDi" 'doxymacs-insert-file-comment)
  (define-key doxymacs-mode-map "\C-cDm" 'doxymacs-insert-blank-multiline-comment)
  (define-key doxymacs-mode-map "\C-cDs" 'doxymacs-insert-blank-singleline-comment)
  (define-key doxymacs-mode-map "\C-cD;" 'doxymacs-insert-member-comment)
  (define-key doxymacs-mode-map "\C-cD@" 'doxymacs-insert-grouping-comments))
...
(defface doxymacs-keyword-face
  '((((class color) (background light)) (:foreground "chocolate1" :bold t))
    (((class color) (background  dark)) (:foreground "chocolate1" :bold t))
    (t (:bold t)))
  "*Face of Doxygen Keywords."
  :group 'doxymacs)
(defvar doxymacs-keyword-face 'doxymacs-keyword-face)

(defface doxymacs-otherword-face
  '((((class color) (background light)) (:foreground "chocolate1" :bold nil))
    (((class color) (background  dark)) (:foreground "chocolate1" :bold nil))
    (t (:bold nil)))
  "*Face of Keywords (yet) unknown to Doxygen."
  :group 'doxymacs)
(defvar doxymacs-otherword-face 'doxymacs-otherword-face)

(defface doxymacs-special-variable-face
  '((t (:inherit font-lock-variable-name-face :italic t :bold nil)))
  "*Face of Doxygen Special variable."
  :group 'doxymacs)
(defvar doxymacs-special-variable-face 'doxymacs-special-variable-face)

(defconst doxymacs-doxygen-tag-prefix "[@\\\\]"
  "Doxygen Tag Prefix."
  )
...
(defconst doxymacs-doxygen-keywords
  (list
   (list
    ...
    (concat "\\(" doxymacs-doxygen-tag-prefix "\\(brief\\|li\\|\\(end\\)?code\\|sa"
	    "\\|note\\|\\(end\\)?verbatim\\|return\\|arg\\|fn"
	    "\\|hideinitializer\\|showinitializer"
	    ;; FIXME: How do I get & # < > % to work?
	    ;;"\\|\\\\&\\|\\$\\|\\#\\|<\\|>\\|\\%"
	    "\\|\\$"
    ...
    '(0 doxymacs-keyword-face prepend))
   ;; attention, warning, etc. given a different font
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix
	    "\\("
	    (regexp-opt
	     (list "attention" "warning" "todo" "bug" "note"
		   "ATTENTION" "WARNING" "TODO" "BUG" "NOTE"))
	    "\\)" "\\)" "\\>")
    '(0 font-lock-warning-face prepend))
   ;; keywords that take a variable name as an argument
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix "t?param" "\\)"
	    "\\(?:" _* "\\["
	    "\\(" (regexp-opt (list "in" "out" "in,out"))
	    "\\)" "\\]" "\\)"
	    _* "\\(" W+ "\\)")
    '(1 doxymacs-keyword-face prepend)
   ...
   ;; keywords that take a special variable name as an argument
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix "a" "\\>" "\\)"
	    _+ "\\(" W+ "\\)")
    '(1 doxymacs-keyword-face prepend)
    '(2 doxymacs-special-variable-face prepend))
   ;; keywords that take a variable name as an argument
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix
	    "\\(" (regexp-from-alts (list "namespace"
					 (concat "relates" "\\(" "also" "\\)?")
					 "var" "def"))
	    "\\)" "\\)"
	    _+ "\\(" W+ "\\)")
   ...
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix "retval\\)"
	    _+
	    "\\(" W+ "\\)")	;NOTE: Originally "[^ \t\n]+"
    '(1 doxymacs-keyword-face prepend)
   ...
   ;; bold
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix "b" "\\)"
	    _+
	    "\\(" W+ "\\)")	;NOTE: Originally "[^ \t\n]+"
    '(1 doxymacs-keyword-face prepend)
   ...
   ;; code
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix "[c]" "\\)"
	    _+
	    "\\(" W+ "\\)")	;NOTE: Originally "[^ \t\n]+"
    '(1 doxymacs-keyword-face prepend)
   ...
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix "[p]" "\\)"
	    _+
	    "\\(" W+ "\\)")	;NOTE: Originally "[^ \t\n]+"
    '(1 doxymacs-keyword-face prepend)
    '(2 font-lock-variable-name-face prepend))
   ...
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix "ingroup\\)"
	    _+
	    "\\(" "\\(" W+ _* "\\)+" "\\)" _* "$")
    '(1 doxymacs-keyword-face prepend)
   ...
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix
	    "\\(" "example" "\\|" "\\(dont\\)?" "include" "\\|" "includelineno"
	    "\\|" "htmlinclude" "\\|" "verbinclude" "\\)" "\\)" _+
	    "\\(" "\"?[~:\\/[:alnum:]_. ]+\"?" "\\)")
    '(1 doxymacs-keyword-face prepend)
    '(4 font-lock-string-face prepend))
   ;; dotfile <file> ["caption"]
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix "dotfile\\)"
	    _+
	    "\\(" "\"?[~:\\/[:alnum:]_. ]+\"?" "\\)"
	    "\\(" _+ "\"[^\"]+\"" "\\)?")
    '(1 doxymacs-keyword-face prepend)
   ...
   (list
    (concat "\\(" doxymacs-doxygen-tag-prefix "image\\)"
	    _+
	    "\\(html\\|latex\\)"
	    _+
	    "\\(" "\"?[~:\\/[:alnum:]_. ]+\"?" "\\)"
   ...
   (list
    ...
    '(1 doxymacs-keyword-face prepend)
    '(3 font-lock-string-face prepend))
   ;; non-doxygen attributes
   ;;    (list
   ;;     (concat "\\(" doxymacs-doxygen-tag-prefix W+ "\\)")
   ;;     '(1 doxymacs-otherword-face prepend))
   ))
  ...
  (let* ((tags-buffer (doxymacs-filename-to-buffer f))
	...
	(if (or (eq tags-buffer nil)
		...
		(setq doxymacs-tags-buffers
	      ...
	      (message (concat "Loading " (faze xml 'file) "..."))
...
completion list."
  ...
  (let ((currbuff (current-buffer))
    ...
    (message (concat
	      ...
	      (faze doxymacs-external-xml-parser-executable 'file)
	      "..."))
    (let ((status (call-process-region
	  ...
	  (progn
	    ...
	    (set-buffer currbuff))
	(progn
	  (switch-to-buffer tags-buffer t)
	  (message (concat
