...
;; Use: (prompt-vc-register-file "~/justcxx/.git/COMMIT_EDITMSG")
;; Use: (prompt-vc-register-file "~/justcxx/vec2f.h")
;; Use: (prompt-vc-register-file "~/justcxx/f.h")
;; Use: (prompt-vc-register-file "~/justcxx/dummy.h")
