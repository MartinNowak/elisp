...
;;;###autoload
(unless (fboundp 'functionp) ;Emacs 24 defines `functionp' as built-in.
  (defsubst functionp (x)
...
;; See: http://groups.google.com/group/gnu.emacs.help/browse_thread/thread/1a20b5a9228fdb8b#
(defsubst named-macrop (symbol)
  "Return `t' if SYMBOL is bound to a macro, `nil' otherwise."
  (and (fboundp symbol)
