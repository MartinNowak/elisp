...
(defun compilation-compiler-build-types (compiler &optional lang)
  ...
  (when compiler
    (let ((full-compiler (executable-find compiler))
      ...
      (when full-compiler
        (delq nil
              (cond ((or (string-has-beginning compiler "gcc")
                         (string-has-beginning compiler "g++"))
                     (mapcar (lambda (x)
                               (let ((ver (fourth x)))
                                 (when (or (not ver)
                                   ...
                                   x)))
                             gcc-build-types))
                    ((or (string-has-beginning compiler "clang")
                         (string-has-beginning compiler "clang++"))
                     (mapcar (lambda (x)
                               (let ((ver (fourth x)))
                                 (when (or (not ver)
                                   ...
                                   x)))
                             clang-build-types))
                    ((string-has-beginning compiler "gdc") gdc-build-types)
                    ((string-has-beginning compiler "gdmd") dmd-build-types)
                    ((string-has-beginning compiler "ldmd2") dmd-build-types)
                    ((string-has-beginning compiler "dmd") dmd-build-types)
                    ((string-has-beginning compiler "ghc") ghc-build-types)
                    ((string-has-beginning compiler "gccgo") gccgo-build-types)
                    (t nil)))))))
