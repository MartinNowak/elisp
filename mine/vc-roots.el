...
;; Use: (file-vc-root-directory-p "~/justcxx/")
...
;; Use: (file-under-vc-directory-p "~/justcxx/vec2f.h")
;; Use: (file-under-vc-directory-p "~/justcxx/nxhtml")
;; Use: (file-under-vc-directory-p (elsub "yasnippet"))
;; Use: (file-under-vc-directory-p "~/justcxx/semnet/preg.hpp")
;; Use: (file-under-vc-directory-p "~/justcxx/f.j")
...
(defun vc-roots-log-defaults ()
  ...
  (vc-roots-log-subs "~/justcxx")
  (vc-roots-log-subs "~/justcxx/deps")
...
(when nil
  ...
  (progn (vc-roots-reset)
         (vc-roots-log-defaults)
         (vc-roots-clear-cached-states-under "~/justcxx")))
