          ...
          `((dmd-source-defines ,(cond ((string-equal system-type "gnu/linux")
            ...
            (c-c++-defines ,(cond ((string-equal system-type "gnu/linux")
                                  ...
                                  ((string-equal system-type "openbsd")
                                   "__OpenBSD__")
                                  ((or (string-match "sun" system-type)
                                       (string-equal "solaris" system-type))
                                   "__sun")))))
  ...
  (when nil
    (defadvice message-send-mail (around gmail-message-send-mail protect activate)
      ...
      (if (save-restriction
            ...
            (string-has-end (message-fetch-field "from") "gmail.com")) ;if from an adress ending with gmail.com
...
;;; gdb-shell.el --- minor mode to add gdb features to shell
  ...
  ;; find-file-noselect-1(#<buffer vec2f.h> "~/cognia/vec2f.h" nil nil "~/cognia/vec2f.h" (165228 2054))
  ;; find-file-noselect("~/cognia/vec2f.h" nil nil nil)
  ;; find-file("~/cognia/vec2f.h")
  ;; find-file-at-point()
    ...
    (when (file-exists-p "~/Notes")
      (setq org-agenda-files
	    (concatenate 'list
			 ...
			 (directory-files "~/cognia/dvis" t "TODO")
			 (directory-files "~/cognia/semnet/doc" t "TODO")
			 ))
