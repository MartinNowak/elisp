;; hexl-ediff.el --- EDiff of Binary Files in hexl-mode.
;; See: http://trey-jackson.blogspot.com/2010/10/emacs-tip-38-automatically-diff-binary.html

(defvar ediff-do-hexl-diff nil
  "Stores trigger for doing diff in hexl-mode.")
...
(ad-activate 'ediff-files-internal)
...
(defadvice ediff-setup-diff-regions (around ediff-setup-diff-regions-for-binary-files activate)
  ...
  (condition-case err
    ...
    (error
     ...
     (error (error-message-string err)))))
(ad-activate 'ediff-setup-diff-regions)
